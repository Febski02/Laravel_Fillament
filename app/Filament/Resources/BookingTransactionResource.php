...
class BookingTransactionResource extends Resource
{
                ...
                Forms\Components\Wizard\Step::make('Payment Information')
                    ->schema([
                        ...
                        Forms\Components\FileUpload::make('proof')
                            ...
                            ->image()  // Ensure it's an image upload
                            ->required()
                            ->directory('proofs'),  // You can specify the directory
                    ]),
            ])
    ...
    {
        return $table
            ->query(BookingTransaction::with('workshop'))  // Eager load the workshop relationship
            ->columns([
                ...
                Tables\Columns\ImageColumn::make('workshop.thumbnail')
                    ...
                    ->square()
                    ->url(fn ($record) => asset('storage/'.$record->workshop->thumbnail)), // Ensure correct path
